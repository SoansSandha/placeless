  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden flex flex-col">
      ...
      <main className="flex-grow pt-[160px] pb-[100px] px-6 relative flex flex-col items-center justify-center">
        ...
        >
          <div className="bg-[#f6f9fc] p-10 md:p-12 rounded-[32px] border-2 border-[#e3e8ee] shadow-xl">
            ...
            <h1 className="text-[32px] font-black tracking-[-1px] text-[#0d253d] mb-4">Join Room</h1>
            <p className="text-[#64748d] mb-10 font-medium">Enter your details to jump into the action.</p>
